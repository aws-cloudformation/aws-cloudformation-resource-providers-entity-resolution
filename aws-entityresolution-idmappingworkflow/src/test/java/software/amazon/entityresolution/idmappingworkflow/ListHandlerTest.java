...
public class ListHandlerTest {
    ...
    private static final String WORKFLOW_ARN_1 = "arn:aws:entityresolution:us-east-1:123456789012:idmappingworkflow"
            + "/workflowName1";
    private static final String WORKFLOW_ARN_2 = "arn:aws:entityresolution:us-east-1:123456789012:idmappingworkflow"
            + "/workflowName2";
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final IdMappingWorkflowSummary listIdMappingWorkflow1 = IdMappingWorkflowSummary.builder()
        ...
        final IdMappingWorkflowSummary listIdMappingWorkflow2 = IdMappingWorkflowSummary.builder()
        ...
        final ListIdMappingWorkflowsResponse listIdMappingWorkflowsResponse = ListIdMappingWorkflowsResponse.builder()
                .workflowSummaries(
                        Lists.newArrayList(
                                listIdMappingWorkflow1,
                                listIdMappingWorkflow2))
                .build();

        Mockito.doReturn(listIdMappingWorkflowsResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(ListIdMappingWorkflowsRequest.class), any());
