...
public class DeleteHandlerTest {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DeleteIdMappingWorkflowResponse deleteMatchingWorkflowResponse = DeleteIdMappingWorkflowResponse.builder()
                .build();

        Mockito.doReturn(deleteMatchingWorkflowResponse)
                .when(proxy)
                .injectCredentialsAndInvokeV2(any(DeleteIdMappingWorkflowRequest.class), any());
